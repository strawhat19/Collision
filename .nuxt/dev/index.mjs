...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getRequestHost, getRequestProtocol, getRequestHeaders, setHeader, getHeader, readBody, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, createError, getResponseStatusText, H3Error } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@unhead/ssr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withoutProtocol, withLeadingSlash, withBase, withTrailingSlash, withoutLeadingSlash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/ufo/dist/index.mjs';
import { toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/vue/index.mjs';
import { defineHeadPlugin, tagDedupeKey, tagWeight, HasElementTags, hashCode, NetworkEvents, SortModifiers, processTemplateParams, resolveTitleTemplate, IsBrowser, normaliseEntryTags } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@unhead/shared/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/unstorage/drivers/lru-cache.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/radix3/dist/index.mjs';
import { $fetch as $fetch$1, createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/hookable/dist/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { defineNitroPlugin as defineNitroPlugin$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nitropack/dist/runtime/plugin.mjs';
import Fuse from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/fuse.js/dist/fuse.mjs';
import { resolve as resolve$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/pathe/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/diff/lib/index.mjs';
import MagicString from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/magic-string/dist/magic-string.es.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/unstorage/drivers/fs.mjs';
import { html } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/satori-html/dist/index.js';
import { inline } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@css-inline/css-inline/index.js';
import { createGenerator } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@unocss/preset-wind/dist/index.mjs';
import { Buffer } from 'node:buffer';
import sizeOf from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/image-size/dist/index.js';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/klona/dist/index.mjs';
import playwrightCore from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/playwright-core/index.mjs';
import { Resvg } from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/satori/dist/index.js';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "/Applications/XAMPP/xamppfiles/htdocs/apps/Collision",
  ...
  "nuxt-og-image": {
    ...
    "debug": true,
    "baseCacheKey": "/cache/nuxt-og-image@3.0.0-rc.29",
    "fonts": [
      {
        "cacheKey": "Inter:400",
        "name": "Inter",
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _QfpVfExTVs = (function(nitro) {
...
const _jSCTJlQi3A = defineNitroPlugin(async (nitroApp) => {
...
const _vLMrhrozcU = defineNitroPlugin(async (nitroApp) => {
...
const _f8fWg6H7zh = defineNitroPlugin$1(async (nitro) => {
  return;
});

const _9FKhCJGVCr = defineNitroPlugin$1((nitro) => {
  setTimeout(() => {
...
const _0RLAOO = defineEventHandler(async (e) => {
...
const _soHCcL = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _v3riMx = defineEventHandler(async (e) => {
...
const _VJMI7a = defineEventHandler(async (e) => {
...
const _zPGpbY = defineEventHandler(async (e) => {
...
const _vVBP9f = defineEventHandler(async (e) => {
...
const _8zvnpp = defineEventHandler(async (e) => {
...
const _wntW8z = defineEventHandler(async (e) => {
...
const _Om79t6 = defineEventHandler(async (e) => {
...
const _aoG6rx = defineEventHandler(async (e) => {
...
const _FYBXRb = defineEventHandler(async (e) => {
...
const _3GKwTO = defineEventHandler(async (e) => {
...
const _biKxNI = defineEventHandler(async () => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"];
  const linkDb = [
    ...pagePaths
  ];
...
const _mzVQHW = defineEventHandler(async (e) => {
  return {
    runtimeConfig: useRuntimeConfig(e).public["nuxt-link-checker"]
  };
});

const _lazy_RAeZET = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_qIoOq1 = () => Promise.resolve().then(function () { return font__name___weight___extension_$1; });
const _lazy_mvPXQp = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_w7dIuk = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_RAeZET, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _0RLAOO, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _soHCcL, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _v3riMx, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _VJMI7a, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _zPGpbY, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _vVBP9f, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _8zvnpp, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _wntW8z, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Om79t6, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_qIoOq1, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_mvPXQp, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_w7dIuk, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _aoG6rx, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _FYBXRb, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _3GKwTO, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _biKxNI, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _mzVQHW, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_RAeZET, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    {
        "sourceType": "user",
        "fetch": "https://api.marchantweb.com/sitemap"
    },
    {
        "context": {
            "name": "sitemap:urls",
...
const appHead = {"link":[{"rel":"icon","href":"/icon-dark.svg","type":"image/svg","sizes":"1000x1000"},{"rel":"icon","href":"/icon-light.svg","type":"image/svg","sizes":"1000x1000"},{"rel":"icon","href":"/icon-notext.svg","type":"image/svg","sizes":"1000x1000"},{"rel":"icon","href":"/icon-white.svg","type":"image/svg","sizes":"1000x1000"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const font__name___weight___extension_$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: font__name___weight___extension_
});

const compatibility = {"chromium":"node","satori":"node","resvg":"node","sharp":false,"css-inline":"node"};

const componentNames = [{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"EtP6PjHVxf","pascalName":"Nuxt","kebabName":"nuxt","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"pc4vJGC02t","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"KfQI8hATPp","pascalName":"Pergel","kebabName":"pergel","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"YDrRRvPRVl","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
async function useSatoriRenderer() {
  satoriRendererInstance.instance = satoriRendererInstance.instance || await Promise.resolve().then(function () { return index$1; }).then((m) => m.default);
  return satoriRendererInstance.instance;
}
async function useChromiumRenderer() {
  chromiumRendererInstance.instance = chromiumRendererInstance.instance || await Promise.resolve().then(function () { return index; }).then((m) => m.default);
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///Applications/XAMPP/xamppfiles/htdocs/apps/Collision/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await Promise.resolve().then(function () { return node$4; }).then((m) => m.default);
